...
SET_FFC_TEMP_DELTA_LOW_GAIN = Code(0x0E, 4, 4)
SET_FFC_TEMP_DELTA_HIGH_GAIN = Code(0x0E, 4, 4)
SET_FFC_TEMP_DELTA = Code(0x0E, 2, 2)
...
SHUTTER_POSITION_DICT = dict(open=0x0000, close=0x0001)
...
GET_MANUAL_DDE = Code(0x2C, 0, 2)  # dde
SET_MANUAL_DDE = Code(0x2C, 2, 2)  # dde
